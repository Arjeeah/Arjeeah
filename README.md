...
- 📫 How to reach me: [argea2004@gmail.com](mailto:argea2004@gmail.com)
- 😄 Pronouns: He/Him
...
<details>
  <summary><strong>Arriada Group - E-commerce Store (Vue.js Frontend Enhancement)</strong></summary>
  <br>
  Contributed to the frontend of an e-commerce platform for Arriada Group.
  <ul>
...
<details>
  <summary><strong>Arriada Group - E-commerce Admin Panel (Vue.js Feature Development)</strong></summary>
  <br>
  Enhanced the admin dashboard for the Arriada Group e-commerce platform.
  <ul>
...
<details>
  <summary><strong>Stadium - Full-Stack Reservation System (Laravel & Flutter)</strong></summary>
  <br>
  A comprehensive reservation system designed for small stadiums.
  <ul>
    <li><strong>Backend:</strong> Built with Laravel, featuring a robust REST API, user authentication, and role-based access control.</li>
...
<details>
  <summary><strong>DevFest Flutter Workshop</strong></summary>
  <br>
  An interactive workshop aimed at introducing participants to the fundamentals of Flutter development.
  <ul>
    <li>Delivered engaging presentations, live coding demos, and interactive games to explain core Flutter concepts.</li>
    <li>Created educational content, including video tutorials and hands-on activities, to reinforce learning and encourage practical application.</li>
  </ul>
  <br>
</details>
